  ...
  return (
   <section className='container m-auto mb-[150px]'>
    <div className='flex justify-end gap-10 pr-13 pt-15'>
        ...
        <Link to="/" className='text-[#333333] after'>К вину </Link>
        <Link to="/" className='text-[#333333] after'>Салаты</Link>
        <Link to="/" className='text-[#333333] after'>Супы</Link>
        <Link to="/" className='text-[#333333] after'>Паста и ризотто </Link>
        <Link to="/" className='text-[#333333] after'>Мясо</Link>
        <Link to="/" className='text-[#333333] after'>Рыба </Link>
        <Link to="/" className='text-[#333333] after'>Grill </Link>
        <Link to="/" className='text-[#333333] after'>Мангал </Link>
        <Link to="/" className='text-[#333333] after'>Гарниры</Link>
    </div>
